...
int main() {
  ...
  //Variables enteras 
  int edad = 0; //se declara la varible indicando el tipo, nombre y valor 
  cout <<"El valor inicial de la edad es: " << edad << endl; 
  edad= 18;
  cout << "El valor final de la variable es" << letra << endl; 

  //listas 
  int listas_edades[] = {18, 26, 34, 45, 55}; //se indica que es una lista con Ñ[#include <iostream>
